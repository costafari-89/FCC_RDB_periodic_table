...
--
-- Name: elements u_symbol_name; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT u_symbol_name UNIQUE (symbol, name);


--
-- Name: properties fk_anum; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_anum FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
